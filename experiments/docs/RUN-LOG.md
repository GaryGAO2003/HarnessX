...
- **八拒联合归因(A+B)**:3× 墙钟 300s 切断(全在 A,294-315s 聚墙)/ 3× replay
  60s 帽超时(A1+B2——**3/8 频率,不是低频残余**)/ 2× 真 no-commit(B,178-200s
  提前自停,retry 未救)⇒ **旋钮 6/8,真顽疾 2/8**;墙钟 600s + replay 帽 90-120s
  后预期约 50-75% 轮次能出货。
...
### 会话成本合计(实测)
¥194.14 → ¥143.19(**¥50.95**:十四个 run;S1 校准两谱系 ¥25.75)
