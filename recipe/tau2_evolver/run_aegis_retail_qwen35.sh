#!/usr/bin/env bash
# run_aegis_retail_qwen35.sh — AEGIS evolution for retail domain with qwen3.5-9b agent
...
OUTPUT_DIR=recipe/tau2_evolver/runs/aegis_retail_qwen35

echo "[aegis_retail_qwen35] Starting AEGIS pilot (${DOMAIN}, ${MAX_TASKS:-all} tasks, ${NUM_ROUNDS} rounds) ..."
mkdir -p "${OUTPUT_DIR}"
...
echo "[aegis_retail_qwen35] Done. Results: ${OUTPUT_DIR}/curves.json"
