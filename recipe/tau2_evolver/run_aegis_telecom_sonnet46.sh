#!/usr/bin/env bash
# run_aegis_telecom_sonnet46.sh — AEGIS evolution for telecom domain with claude-sonnet-4-6 agent
...
echo "[aegis_telecom_sonnet46] Done. Results: ${OUTPUT_DIR}/curves.json"
