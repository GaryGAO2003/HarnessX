#!/usr/bin/env bash
# run_aegis_airline_gpt54.sh — AEGIS evolution for airline domain with gpt-5.4 agent
...
OUTPUT_DIR=recipe/tau2_evolver/runs/aegis_airline_gpt54

echo "[aegis_airline_gpt54] Starting AEGIS pilot (${DOMAIN}, ${MAX_TASKS} tasks, ${NUM_ROUNDS} rounds) ..."
mkdir -p "${OUTPUT_DIR}"
...
echo "[aegis_airline_gpt54] Done. Results: ${OUTPUT_DIR}/curves.json"
