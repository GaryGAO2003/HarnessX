...
|---|---|---|---|---|---|
| L0 | 9 | 33 | 9 | **61 题 = 59%** | 0.67（四分位 0.33 / 0.78） |
| L2 | 8 | 36 | 11 | 56 题 = 54% | 0.62（四分位 0.38 / 0.88） |
...
| 量 | 值 |
|---|---|
| 单轮 SD | **2.34 题 = 2.27pp**（df=7） |
| 两轮之差的 SD | 3.30 题 |
| 本设计能判定的最小臂间差（双侧 α=.05，~80% power） | **9.2 题 = 9.0pp** |

**后果**：103 题 × 单种子 × 单轮比较的协议，只能分辨 ~9pp 以上的臂间差。
L0 峰 80 与 L2 峰 77 相差 3 题，远在分辨率以下——**本战役无法分离两臂**，
