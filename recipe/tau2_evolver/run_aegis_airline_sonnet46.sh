#!/usr/bin/env bash
# run_aegis_airline_sonnet46.sh — AEGIS evolution for airline domain with claude-sonnet-4-6 agent
...
OUTPUT_DIR=recipe/tau2_evolver/runs/aegis_airline_sonnet46_v2

echo "[aegis_airline_sonnet46] Starting AEGIS pilot (${DOMAIN}, ${MAX_TASKS:-all} tasks, ${NUM_ROUNDS} rounds) ..."
mkdir -p "${OUTPUT_DIR}"
...
echo "[aegis_airline_sonnet46] Done. Results: ${OUTPUT_DIR}/curves.json"
