...
| 触发 | s1k8b103 中 Evolver 把三个变体的 `template_path` 写成 `file:///D:/...` URI;无人校验;URI 打不开;`harnessx/core/processor.py:714` 的崩溃处理 `yield event` 静默透传 ⇒ V5/V6/V7 的全部 642 次 rollout 跑在 **空系统提示词**上,而准确率曲线照常上升 |
