#!/usr/bin/env bash
# run_aegis_retail_gpt54.sh — AEGIS evolution for retail domain with gpt-5.4 agent
...
OUTPUT_DIR=recipe/tau2_evolver/runs/aegis_retail_gpt54

echo "[aegis_retail_gpt54] Starting AEGIS pilot (${DOMAIN}, ${NUM_ROUNDS} rounds) ..."
mkdir -p "${OUTPUT_DIR}"
...
echo "[aegis_retail_gpt54] Done. Results: ${OUTPUT_DIR}/curves.json"
