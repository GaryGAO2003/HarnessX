#!/usr/bin/env bash
# run_aegis_telecom_qwen35.sh — AEGIS evolution for telecom domain with qwen3.5-9b agent
...
OUTPUT_DIR=recipe/tau2_evolver/runs/aegis_telecom_qwen35

echo "[aegis_telecom_qwen35] Starting AEGIS pilot (${DOMAIN}, ${MAX_TASKS:-all} tasks, ${NUM_ROUNDS} rounds) ..."
mkdir -p "${OUTPUT_DIR}"
...
echo "[aegis_telecom_qwen35] Done. Results: ${OUTPUT_DIR}/curves.json"
